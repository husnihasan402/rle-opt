...
#    style.say_balloon.xanchor = 500
    ...
    style.say_balloon.xminimum = 150
...
init python:
    ...
    build.directory_name = "Rogue-Like-1.64d"
...
# My junk
    ...
    config.layers = [ 'backdrop', 'master', 'nightmask', 'black', 'transient', 'screens', 'overlay','red' ]
